    ...
    <div className="country-container">
      ...
      <div className="country-info-details">
        <div className="country-info">
          ...
          <p>
            🗺️ <strong>Continent: </strong> {data?.region}
          </p>
          <p>
            🌍 <strong>Region: </strong> {data?.subregion}
          </p>
          <p>
        ...
        <div className="country-info">
          <p>
            ...
            {new Intl.NumberFormat().format(data?.population)} M
          </p>
          <p>
            📏 <strong>Area: </strong>{" "}
            {new Intl.NumberFormat().format(data?.area)} km²
          </p>
          <p>
